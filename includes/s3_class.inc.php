...
/*  @file
 * This is the class file taken straight from Andy's Nagios Looking Glass and made
 * Compliant with Drupal coding standards.
   +----------------------------------------------------------------------------------+
...
class S3_NetworkFilter {
  ...
  function ApplyFilter($Status, $Hostname) {
    ...
    settype($Status, "integer");
        settype($Hostname, "string");
/* Need to replace 'strtolower' with Drupal native
